        ...
        <div className="order-2 md:order-1 h-full w-full md:w-1/2 ">
          <div className=" mt-28 space-y-8 ">
            ...
            <p className="text-xl">
              ...
              inspire and empower your learning journey. Whether you&apose;re
              here to explore cutting-edge technologies, master new skills, or
              deepen your understanding of the world around us, you&apose;ll
              find everything you need to fuel your passion for continuous
              growth.
            </p>
          ...
          <button onClick={handleEmail} className="mt-6 btn btn-secondary ">
            Get Started
          </button>
        </div>
